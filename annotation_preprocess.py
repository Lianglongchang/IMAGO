            ...
            for protein_name in train_aspect_annot_dic[go_id]:
                ...
                for x in protein_ext_names:
                    ...
                    if protein_id not in Annot['indx'][aspect]['train']:
                        ...
                        Annot['GO'][aspect]['train'].append(np.zeros(num_aspect_annotations, dtype = int).tolist())
            ...
            for protein_name in p_valid_aspect_annot_dic[go_id]:
                ...
                for x in protein_ext_names:
                    ...
                    if protein_id not in Annot['indx'][aspect]['valid']:
                        ...
                        Annot['GO'][aspect]['valid'].append(np.zeros(num_aspect_annotations, dtype = int).tolist())
            ...
            for protein_name in p_test_aspect_annot_dic[go_id]:
                ...
                for x in protein_ext_names:
                    ...
                    if protein_id not in Annot['indx'][aspect]['test']:
                        ...
                        Annot['GO'][aspect]['test'].append(np.zeros(num_aspect_annotations, dtype = int).tolist())
...
if __name__ == '__main__':
    ...
    parser.add_argument('-data_path', '--data_path', default= r'~/IMAGO/Dataset', type = str, help = "the row data path")
    parser.add_argument('-af', '--annotation_file', default= r'~/IMAGO/Dataset/mouse/mgi.gaf', type = str, help = "the input train annotation file")
    parser.add_argument('-pf', '--protein_file', default= r'~/IMAGO/Dataset/mouse/10090.protein.info.v11.5.txt', type = str, help = "the input protein file")
    parser.add_argument('-ppif', '--ppi_file', default= r'~/IMAGO/Dataset/mouse/10090.protein.links.detailed.v11.5.txt', type = str, help = "the input ppi file")
    parser.add_argument('-org', '--organism', default= 'mouse', type = str, help = "the organism")
    parser.add_argument('-stl', '--start_line', default= 41, type = int, help = "the start line of Gene Ontology annotation file")
