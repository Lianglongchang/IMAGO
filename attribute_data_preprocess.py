...
if __name__ == '__main__':
    ...
    parser.add_argument('-data_path', '--data_path', default= r'~/IMAGO/Dataset', type = str, help = "the data_path")
    ...
    parser.add_argument('-org', '--organism', default= 'mouse', type = str, help = "the data_path")
    parser.add_argument('-uniprot', '--uniprot_file', default= r'~/IMAGO/Dataset/mouse/uniprot-download_true_fields_accession_2Creviewed_2Csequence_2Cxref_-2022.06.29-08.34.18.65.tsv', type = str, help = "uniprot_file")
